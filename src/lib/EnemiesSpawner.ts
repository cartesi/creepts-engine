            ...
            if (nextEnemyData.t === this.engine.ticksCounter) {
                switch (nextEnemyData.type) {
                    case GameConstants.ENEMY_SOLDIER:
                        enemy = new Enemy(
                            GameConstants.ENEMY_SOLDIER,
                            this.engine.ticksCounter,
                            this.engine
                        );
                        break;
                    case GameConstants.ENEMY_RUNNER:
                        enemy = new Enemy(
                            GameConstants.ENEMY_RUNNER,
                            this.engine.ticksCounter,
                            this.engine
                        );
                        break;
                ...
                enemy.life = Math.round(
                    enemy.life * this.engine.enemyHealthModifier
                );
                enemy.maxLife = enemy.life;
                enemy.value = Math.round(
                    enemy.value * this.engine.enemyRewardModifier
                );
